...
\textbf{Palavras-chaves}: Desinformação, sumarização automática, extração de termos-chave, segmentação textual, aprendizado de máquina.
\end{resumo}
...
\begin{resumo}[Abstract]
 \begin{otherlanguage*}{english}
   ...
   \noindent 
   \textbf{Keywords}: Disinformation, automatic summarization, key term extraction, text segmentation, machine learning.
 \end{otherlanguage*}
\end{resumo}
