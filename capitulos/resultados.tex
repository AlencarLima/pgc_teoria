...
\begin{figure}[H] % ou [!htb] se preferir deixar o LaTeX decidir
    \centering
    \includegraphics[width=0.9\textwidth]{figs/factual_graph.png} % coloque o arquivo na pasta escolhida
...
\begin{figure}[H] % ou [!htb] se preferir deixar o LaTeX decidir
    \centering
    \includegraphics[width=0.9\textwidth]{figs/radar_modelos.png} % coloque o arquivo na pasta escolhida
...
\begin{figure}[H] % ou [!htb] se preferir deixar o LaTeX decidir
    \centering
    \includegraphics[width=0.9\textwidth]{figs/tweets_graph_manual.png} % coloque o arquivo na pasta escolhida
...
\begin{figure}[H] % ou [!htb] se preferir deixar o LaTeX decidir
    \centering
    \includegraphics[width=0.9\textwidth]{figs/tweets_graph_bert.png} % coloque o arquivo na pasta escolhida
    \caption{Gráfico tweets com desinformação em relação aos retuítes de cada
...
\begin{figure}[H] % ou [!htb] se preferir deixar o LaTeX decidir
    \centering
    \includegraphics[width=0.9\textwidth]{figs/tweets_graph_dbert.png} % coloque o arquivo na pasta escolhida
    \caption{Gráfico tweets com desinformação em relação aos retuítes de cada
...
\begin{figure}[H] % ou [!htb] se preferir deixar o LaTeX decidir
    \centering
    \includegraphics[width=0.9\textwidth]{figs/tweets_graph_sbert.png} % coloque o arquivo na pasta escolhida
    \caption{Gráfico tweets com desinformação em relação aos retuítes de cada
...
\begin{figure}[H] % ou [!htb] se preferir deixar o LaTeX decidir
    \centering
    \includegraphics[width=0.9\textwidth]{figs/tweets_graph_que.png} % coloque o arquivo na pasta escolhida
    \caption{Gráfico tweets com desinformação em relação aos retuítes de cada
...
\begin{figure}[H] % ou [!htb] se preferir deixar o LaTeX decidir
    \centering
    \includegraphics[width=0.9\textwidth]{figs/retuites_graph_manual.png} % coloque o arquivo na pasta escolhida
...
\begin{figure}[H] % ou [!htb] se preferir deixar o LaTeX decidir
    \centering
    \includegraphics[width=0.9\textwidth]{figs/retuites_graph_bert.png} % coloque o arquivo na pasta escolhida
    \caption{Gráfico dos retuítes de tweets com desinformação em relação aos retuítes de cada
cluster obtidos com termos-chave BERT - Mês de outubro/2022}
...
\begin{figure}[H] % ou [!htb] se preferir deixar o LaTeX decidir
    \centering
    \includegraphics[width=0.9\textwidth]{figs/retuites_graph_dbert.png} % coloque o arquivo na pasta escolhida
    \caption{Gráfico dos retuítes de tweets com desinformação em relação aos retuítes de cada
cluster obtidos com termos-chave DistilBERT - Mês de outubro/2022}
...
\begin{figure}[H] % ou [!htb] se preferir deixar o LaTeX decidir
    \centering
    \includegraphics[width=0.9\textwidth]{figs/retuites_graph_sbert.png} % coloque o arquivo na pasta escolhida
    \caption{Gráfico dos retuítes de tweets com desinformação em relação aos retuítes de cada
cluster obtidos com termos-chave sBERT - Mês de outubro/2022}
...
\begin{figure}[H] % ou [!htb] se preferir deixar o LaTeX decidir
    \centering
    \includegraphics[width=0.9\textwidth]{figs/retuites_graph_que.png} % coloque o arquivo na pasta escolhida
    \caption{Gráfico dos retuítes de tweets com desinformação em relação aos retuítes de cada
cluster obtidos com termos-chave baseados em ``que'' - Mês de outubro/2022}
