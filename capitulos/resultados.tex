...
Apesar de apresentar métricas menos eficientes, o modelo conseguiu extrair textos relevantes de todas as 29 notícias analisadas. Para o $cluster_0$, houve o retorno de 2.504 tuítes, enquanto para o $cluster_1$, o modelo retornou 1.366 tuítes. Entre as frases relevantes extraídas, destacam-se exemplos como: ``o TSE (Tribunal Superior Eleitoral) não testou a segurança das urnas para as eleições de 2022''. No entanto, o modelo também retornou frases menos relevantes, como: ``no Telegram disseminam informações falsas sobre o'', ``estão registrados na seção'' e ``circulam nas redes sociais (veja aqui)''. Esse comportamento destaca a necessidade de aprimorar a precisão do modelo na filtragem de conteúdo, evitando a extração de dados que não são essenciais, o que pode aumentar o tempo de processamento e reduzir a eficiência geral do sistema.
