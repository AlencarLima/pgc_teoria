...
O Aprendizado Profundo (\textit{Deep Learning – DL}) representa uma evolução do ML, caracterizando-se pela utilização de redes neurais artificiais com múltiplas camadas de processamento. Essas redes são capazes de modelar relações complexas e não lineares nos dados, tornando-se particularmente eficazes em tarefas envolvendo linguagem natural.  
...
DistilBERT, SBERT (\textit{Sentence-BERT}) e XLM-RoBERTa, aprimoraram o PLN ao oferecer representações contextuais mais detalhadas e precisas. 
